...
function Login({ onClose, handleSignUp }) {
  ...
  return (
    <div className="fixed inset-0  bg-tranparent backdrop-blur-lg z-50 flex justify-center items-center transition-opacity duration-300 ">
      <div className=" bg-[url(./loginBg.jpg)] bg-cover w-[60vh] theme-bg-2 h-auto text-white rounded-md">
        <div className="relative bg-black/25 backdrop-blur-md h-auto  pt-9">
          ...
          <form className="flex flex-col items-center mt-5 " action="">
            <div className="  p-3  mb-4">
              <br />
              <span className="absolute flex items-center pt-2 pl-3 text-gray-500 text-2xl">
                {" "}
                <MdEmail />
              </span>
              <input
          ...
          <p className="text-xs text-center mt-2 text-[#e7dddd] pb-3">
            Don't have an account ?
            <a className="text-amber-300 cursor-pointer" onClick={handleSignUp}>
              {" "}
              Register
            </a>
          </p>
